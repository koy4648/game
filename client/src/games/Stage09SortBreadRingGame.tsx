  ...
  return (
    ...
    >
      ...
      {cleared && (
        <div className="flex-1 flex flex-col items-center justify-center px-4 py-6">
          <div
            className="card-glow p-8 text-center max-w-sm w-full s9-bounce-in"
            style={{
              background: `linear-gradient(150deg, ${C.cream} 0%, ${C.pinkL} 50%, ${C.goldL} 100%)`,
              border: `2px solid ${C.pink}55`,
              borderRadius: 28,
              boxShadow: `0 16px 48px ${C.pink}33, 0 2px 0 ${C.white} inset`,
            }}
          >
            <div style={{ fontSize: "2.2rem", letterSpacing: "0.15em", marginBottom: 10 }}>
              🎉🍓💍🎀🎉
            </div>
            <h2 style={{
              fontSize: "1.22rem", fontWeight: 800, marginBottom: 6,
              color: C.brownD, fontFamily: "'Gowun Dodum', sans-serif",
            }}>
              1주년 데이트 완료! 🥂
            </h2>
            <p style={{
              fontFamily: "'Gowun Dodum', sans-serif",
              fontSize: "0.82rem", color: C.textL, lineHeight: 1.9, marginBottom: 6,
            }}>
