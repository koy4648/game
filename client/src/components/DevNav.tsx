...
const PAGES = [
  ...
  { label: "🎂 2. 문래 생일", path: "/stage/2" },
  { label: "💕 3. 시청 고백", path: "/stage/3" },
  { label: "🎢 4. 에버랜드", path: "/stage/4" },
  { label: "🐠 5. 코엑스 아쿠아리움", path: "/stage/5" },
  { label: "🦀 6. 포항·영덕", path: "/stage/6" },
  { label: "🍊 7. 제주도", path: "/stage/7" },
  { label: "🍓 8. 대전 1주년", path: "/stage/8" },
  { label: "🌸 9. 400일 벚꽃", path: "/stage/9" },
  { label: "🍵 10. 보성 마라톤", path: "/stage/10" },
  { label: "⚾ 11. 야구장", path: "/stage/11" },
  { label: "📝 퀴즈", path: "/quiz" },
